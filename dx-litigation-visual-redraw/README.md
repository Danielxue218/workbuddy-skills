...
<p align="center">
  ...
  <a href="https://github.com/MiaoQichuan/dx-litigation-visual-redraw/actions/workflows/checks.yml"><img src="https://github.com/MiaoQichuan/dx-litigation-visual-redraw/actions/workflows/checks.yml/badge.svg" alt="checks"/></a>
</p>

---

# dx-litigation-visual-redraw · 诉讼可视化重画

> 把一张凌乱或"AI 味"的诉讼图，重画成克制、专业、可直接进诉讼材料的 **SVG + PNG**。
> 不改一个字、不改法律含义，只提升视觉表达。

**定位**：本 skill（`dx-litigation-visual-redraw`）是 **新诉讼可视化 / New Litigation Visualization**
