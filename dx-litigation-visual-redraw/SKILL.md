---
name: dx-litigation-visual-redraw
metadata:
  author: Daniel Xue (薛龙)
  version: 1.0.0
  last_updated: 2026-07-27
  based_on: 缪奇川律师 mqc-litigation-visual-redraw v1.0.0
description: >-
...
This skill is **`dx-litigation-visual-redraw`** — customized from 缪奇川's open-source module of
