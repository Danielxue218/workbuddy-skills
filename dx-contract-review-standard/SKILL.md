---
name: dx-contract-review-standard
...
author: Daniel Xue (薛龙)
brand: DX Legal Tools · 薛龙律师专属
applicable_law: 中华人民共和国内地法律体系
license: MIT
---

# dx-contract-review-standard
...
**dx-contract-review-standard** 是一个可加载进 WorkBuddy 的**法律工作 Skill**——不是一条提示词，不是一套模板，是一个完整的工作系统。
...
![dx-contract-review-standard 工作架构](examples/01-architecture-sample.svg)
...
| 需求场景 | 对应 Skill | 状态 |
| --- | --- | --- |
| 标准审查（本 skill） | dx-contract-review-standard | ✓ v2.0 |
